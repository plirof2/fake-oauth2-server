...
class GsisLoginController extends ControllerBase {
  ...
  public function __construct(ConfigFactoryInterface $config_factory, RequestStack $request_stack, Client $http_client, LanguageManager $language_manager) {
    ...
    $this->redirectUri = "http://localhost/drupal84/gsis";
...
*/
      $this->tokenUrl = 'http://localhost:8282/oauth2/v4/token';
      $this->userinfoUrl = 'http://localhost:8282/oauth2/v3/userinfo';
      $this->authorizeUrl = 'http://localhost:8282/o/oauth2/v2/auth';
...
drupal_set_message('AAAAAAAAAAA DECODE'.($userxml));
        //$userid = $xml->userid;
